...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <i class="icon-edit"></i>
            <a href="<?php echo base_url('add/brand')?>">Agregar Marca</a>
        </li>
    </ul>
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon edit"></i><span class="break"></span>Agregar Marca</h2>
                <div class="box-icon">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo base_url('save/brand')?>" method="post">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="textarea2">Descripcion de la marca</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="textarea2">Estado Publicacíon</label>
                            <div class="controls">
