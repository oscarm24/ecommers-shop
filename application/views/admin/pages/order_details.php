...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('manage/order') ?>">Detalles de pedidos</a></li>
    </ul>

    <div class="row-fluid sortable">		
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon user"></i><span class="break"></span>Detalles de pedidos</h2>
                <div class="box-icon">
            ...
            <div class="box-content">
                <div class="span4 text-left">
                    <h2>Información del Cliente(00<?php echo $customer_info->customer_id; ?>)</h2>
                ...
                <div class="span4 text-right" class="table table-striped table-bordered">
                    <h2>Información del envío(00<?php echo $shipping_info->shipping_id; ?>)</h2>
                    <table class="table table-striped table-bordered">
                        <tr>
                            <td>Nombre : </td>
                    ...
                    <tbody>
                        ...
                        foreach ($order_details_info as $single_order_details) {
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo base_url('uploads/'.$single_order_details->product_image);?>" class="img-responsive" style="width:200px;height:100px"/></td>
