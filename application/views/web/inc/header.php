        ...
        <div class="menu">
            <ul id="dc_mega-menu-orange" style="float:left" class="dc_mm-orange">
                ...
                ?>"><a href="<?php echo base_url('/product'); ?>">Productos</a> </li>
                    ...
                    ?>"><a href="<?php echo base_url('/cart'); ?>">Carrito</a></li>
                    <?php } ?>
                <li class="<?php
                if ($this->uri->uri_string() == 'contact') {
                    echo "active";
                }
                ?>"><a href="<?php echo base_url('/contact'); ?>">Contáctanos</a> </li>
                ...
                ?>"><a href="<?php echo base_url('/customer/login'); ?>">Inicio sesión</a> </li>
                <li class="<?php
                if ($this->uri->uri_string() == 'customer/register') {
                    echo "active";
                }
                ?>"><a href="<?php echo base_url('/customer/register'); ?>">Registrarse</a> </li>
