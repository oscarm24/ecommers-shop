        ...
        <div class="section group">
            <div class="cont-desc span_1_of_2">				
                ...
                <div class="desc span_3_of_2">
                    ...
                    <div class="price">
                        <p>Precio: <span>$<?php echo $this->cart->format_number($get_single_product->product_price)?></span></p>
                        <p>Categoria: <span><?php echo $get_single_product->category_name?></span></p>
                        <p>Marca:<span><?php echo $get_single_product->brand_name?></span></p>
                    </div>
                    <div class="add-cart">
                        <form action="<?php echo base_url('save/cart');?>" method="post">
                            ...
                            <input type="submit" class="buysubmit" name="submit" value="Comprar"/>
                        </form>				
                    </div>
                </div>
